import type { FastFlag, FastFlagBehavior, FastFlagKind } from "./parser.js";
...
export function enrichFastFlag(
  ...
  if (name.startsWith("FInt") || name.startsWith("DFInt") || name.startsWith("SFInt")) {
    ...
    name.startsWith("FString") ||
    name.startsWith("DFString") ||
    name.startsWith("SFString")
  ) {
    kind = "FString";
  ...
  if (
    ...
    name.startsWith("FInt") ||
    name.startsWith("FString") ||
    name.startsWith("FLog")
  ) {
    behavior = "Fast";
